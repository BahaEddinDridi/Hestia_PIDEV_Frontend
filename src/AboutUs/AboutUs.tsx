                  ...
                  <div className="place-self-center">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                          <div className="text-center">
                              <img alt="Mohsen's headshot" className="mx-auto border-4 border-red-500 h-32 md:h-60 md:w-60 rounded-full w-32" decoding="async"  loading="lazy" src={Mohsen} style={{ height: '250px', width: '200px' }} />
                          ...
                          <div className="text-center">
                              <img alt="Khalil's headshot" className="mx-auto border-4 border-red-500 h-32 md:h-60 md:w-60 rounded-full w-32" decoding="async"  loading="lazy" src={Baha} style={{ height: '250px', width: '200px' }}  />
                              <div className="mt-2 sm:mt-4">
                          ...
                          <div className="text-center">
                              <img alt="Farah's headshot" className="mx-auto border-4 border-red-500 h-32 md:h-60 md:w-60 rounded-full w-32" decoding="async"  loading="lazy" src={Farah} style={{ height: '250px', width: '200px' }}  />
                              <div className="mt-2 sm:mt-4">
                          ...
                          <div className="text-center">
                              <img alt="Sarra's headshot" className="mx-auto border-4 border-red-500 h-32 md:h-60 md:w-60 rounded-full w-32" decoding="async"  loading="lazy" src={Sarra} style={{ height: '250px', width: '200px' }}  />
                              <div className="mt-2 sm:mt-4">
                          ...
                          <div className="text-center">
                              <img alt="Oumaima's headshot" className="mx-auto border-4 border-red-500 h-32 md:h-60 md:w-60 rounded-full w-32" decoding="async"  loading="lazy" src={Omayma} style={{ height: '250px', width: '200px' }}  />
                              <div className="mt-2 sm:mt-4">
