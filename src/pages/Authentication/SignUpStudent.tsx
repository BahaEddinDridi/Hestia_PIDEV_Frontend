...
import PhoneNumberValidation from '../Authentication/SignUpFiles/PhoneNumber';
...
const SignUpStudent: React.FC = () => {
  ...
  const handleGoogleLoginSuccess = async (credentialResponse) => {
    try {
      ...
      dispatch(
        setCredentials({ accessToken: accessToken, currentUser: currentUser }),
      );
      navigate('/Profile');
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    //Terms & Conditions
    if (!isChecked) {
      // Vérifier si ReCAPTCHA n'est pas cochée
          ...
          <div className="hidden w-full xl:block xl:w-1/2 ">
            <div className="px-26 text-center ">
              ...
              <p className="2xl:px-2">
                Welcome to our WebSite Esprit Career . We hope you will find
                your dream job by using our Plateform.
              </p>
            </div>
          </div>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5 ">
              ...
              {showFirstForm && (
                <form className="form1" onSubmit={handleShowFirstForm}>
                    ...
                    <div className="mb-4 mr-4 ml-4">
                      ...
                      <div className="relative">
                        ...
                        {error && firstName.length <= 0 ? (
                          ...
                          firstName.length > 0 ? (
                          <label className="text-esprit">
                            Your First Name should have only letters
                          </label>
                        ) : null}
                        {/* ********************************************************************************************************************** */}
                    ...
                    <div className="mb-4 mr-4 ml-4">
                      ...
                      <div className="relative">
                        ...
                        {error && lastName.length <= 0 ? (
                          ...
                          lastName.length > 0 ? (
                          <label className="text-esprit">
                            Your Last Name should have only letters
                          </label>
                        ) : null}
                        {/* ********************************************************************************************************************** */}
                    ...
                    <div className="mb-4 mr-4 ml-4">
                      ...
                      <div className="relative">
                        ...
                        {error && userName.length <= 0 ? (
                          ...
                          <label className="text-esprit">
                            You can't have space in your User Name
                          </label>
                        ) : userName.length > 10 ? (
                          <label className="text-esprit">
                          ...
                          <label className="text-esprit">
                            Your User Name should contain only letters, numbers,
                  ...
                  <button
                    ...
                    className="ml-auto relative inline-flex items-center justify-start py-3 pl-[20px] pr-12 overflow-hidden font-semibold shadow text-esprit transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 dark:bg-gray-700 dark:text-white dark:hover:text-gray-200 dark:shadow-none group"
                  >
              ...
              {showSecondForm && (
                <form className="form2" onSubmit={handleShowSecondForm}>
                  ...
                  <button
                    onClick={handleShowFirstForm}
                    className=" ml-4 relative inline-flex items-center justify-start py-3 pl-12 pr-4 overflow-hidden font-semibold shadow text-esprit transition-all duration-150 ease-in-out rounded hover:pr-10 hover:pl-6 bg-gray-50 dark:bg-gray-700 dark:text-white dark:hover:text-gray-200 dark:shadow-none group"
                  >
                    ...
                    <span className="relative w-full text-right transition-colors duration-200 ease-in-out group-hover:text-white dark:group-hover:text-gray-200">
                      Previous
                    </span>
                  </button>
