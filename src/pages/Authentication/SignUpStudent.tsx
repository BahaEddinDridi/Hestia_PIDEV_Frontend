                                        ...
                                        <div className="mb-4 mr-4 ml-4">
                                            ...
                                            <div className="relative">
                                                ...
                                                {error && birthDate.length <= 0 ? (
                                                    <label className='text-esprit'>Birth Date can't be Empty</label>
                                                ) : (
                                                    ...
                                                    error && (age < 18 || (age === 18 && (monthDiff < 0 || (monthDiff === 0 && dayDiff < 0)))) ? (
                                                        <label className='text-esprit'>You must be at least 18 years old</label>
                                                    ) : null
                                                )}
                                        ...
                                        <div className="mb-4 mr-4 ml-4">
                                            ...
                                            <div className="relative">
                                                ...
                                                {error && gender.length <= 0 ?
                                                    <label className='text-red'>gender can't be Empty</label> : ""
                                                }
