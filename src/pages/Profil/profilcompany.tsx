    ...
    if (selectedFile) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          localStorage.setItem(`userImage_${userInfo.username}`, result.secure_url);
  ...
  const handleImageChange = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 ml-10 -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              {userInfo.image ? (
                  <img src={userInfo.image} alt="profile" className='w-50 h-40 rounded-full overflow-hidden object-cover' />
              ) : selectedImage ? (
    ...
    <div className="mb-10 mr-7 ml-7 rounded-lg bg-white border border-stroke shadow-md dark:border-strokedark dark:bg-boxdark">
        <div className="flex items-center rounded-lg justify-between border-b border-stroke p-4 px-6.5 dark:border-strokedark bg-gradient-to-r from-graydegrade to-graydouble">
          <h3 className="font-medium text-lg  w-full h-full uppercase text-black">Info</h3>
        ...
        <div className="flex p-4">
          ...
          <p className="font-medium"> {userInfo && `${userInfo.title} `}</p>
      ...
      <div className=" bg-white mb-10 mr-7 ml-7 rounded-lg">
      <div className="flex items-center rounded-lg justify-between border-b border-stroke p-4 px-6.5 dark:border-strokedark bg-gradient-to-r from-graydegrade to-graydouble">
          <h3 className="font-medium text-lg  w-full h-full uppercase text-black">Company Posts</h3>
          
        </div>
      
      <div className="grid gap-6 md:grid-cols-2">
        {/* Publication 1 */}
        <div className="bg-red-800 mt-2 ml-2 dark:bg-gray-700 rounded-lg shadow-md overflow-hidden">
          <div className="p-2">
            <div className="flex items-center mb-4">
              <img className="w-10 h-10 rounded-full mr-4" src="https://via.placeholder.com/50" alt="John Doe" />
              <div>
                <p className="font-medium text-white dark:text-gray-200">John Doe</p>
                <p className="text-sm text-white dark:text-gray-400">March 21, 2024</p>
              </div>
            </div>
            <p className="text-white dark:text-gray-200 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis suscipit euismod leo eget hendrerit.</p>
            <img className="w-full h-48 object-cover rounded-md" src="https://via.placeholder.com/500x250" alt="Post" />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden">
          <div className="p-4">
            <div className="flex items-center mb-4">
              <img className="w-10 h-10 rounded-full mr-4" src="https://via.placeholder.com/50" alt="Jane Doe" />
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200">Jane Doe</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">March 22, 2024</p>
              </div>
            </div>
            <p className="text-gray-800 dark:text-gray-200 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis suscipit euismod leo eget hendrerit.</p>
            <img className="w-full h-48 object-cover rounded-md" src="https://via.placeholder.com/500x250" alt="Post" />
          </div>
        </div>
