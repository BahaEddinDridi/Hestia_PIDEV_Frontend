  ...
  return (
    <div className="">
      ...
      <aside
        ...
        className="fixed top-30 left-10 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
          ...
          <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            <li>
              <a
                ...
                className={`flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group ${activeSection === 'account' ? 'bg-red-500 text-white' : ''
                  }`}
              >
                ...
                <span className="ms-3"> Account Visibility</span>
              </a>
            </li>
