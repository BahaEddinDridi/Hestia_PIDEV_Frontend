        ...
        <>
            <DefaultLayout>
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    {currentUser?.job && currentUser.job.map((job: Job) => (
                        <div key={job._id} className="p-6 bg-white shadow-md rounded-lg mb-4">
                            <div className="flex items-center mb-4">
                                <img src={currentUser.image} className="w-20 h-20 rounded-full overflow-hidden object-cover" />
                                <h2 className="text-xl font-semibold ml-4">{job.jobTitle}</h2>
                            </div>
                            ...
                            <div className="flex items-center mb-2">
                                ...
                                <div className="text-sm text-gray-600">{job.jobPost}</div>
                            </div>
                            <div className="flex items-center mb-2">
                                ...
                                <div className="text-sm text-gray-600 mb-2">{job.jobfield}</div>
                            </div>
                            <div className="flex items-center text-sm text-gray-600 mb-2">
                                ...
                                <b className="text-black">Job Start Date:</b> <span className="mr-4">{formatDate(job.jobStartDate)}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="w-6 h-6 text-red-800 mr-2">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <line x1="12" y1="8" x2="12" y2="12"></line>
                                    <line x1="12" y1="16" x2="12" y2="16"></line>
                                </svg>
                                <b className="text-black">Job Application Deadline:</b> <span>{formatDate(job.jobApplicationDeadline)}</span>
                            </div>
                            <div className="border-t border-gray-200 pt-4">
                                <h3 className="text- text-black font-semibold mb-2">About the Job Offer</h3>
                                <p className="text-gray-800">{job.jobDescription}</p>
                            </div>
                            ...
                            <div className="border-t border-gray-200 pt-4">
                                ...
                                <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                                    <div className="mb-4">
                                        ...
                                        <p className="text-gray-800">{job.jobRequiredSkills}</p>
                                    </div>
                                    <div className="mb-4">
                                        <h4 className="text-red-800 font-semibold mb-1">Required Education</h4>
                                        <p className="text-gray-800">{job.jobRequiredEducation}</p>
                                    </div>
                                    <div className="mb-4">
                                        <h4 className="text-red-800 font-semibold mb-1">Required Experience</h4>
                                        <p className="text-gray-800">{job.jobRequiredExperience}</p>
                                    </div>
                                </div>
                            </div>
