    ...
    <div className="flex justify-center items-center min-h-screen mt-15">
      <div className="flex flex-col sm:flex-row justify-center sm:space-x-4">
        ...
        <div className="max-w-sm mb-4 sm:mb-0 bg-white dark:bg-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            <a href="#">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{t('Join as a Student')}</h5>
            </a>
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{t('Explore educational opportunities and connect with other students.')}</p>
        ...
        <div className="max-w-sm mb-4 sm:mb-0 bg-white dark:bg-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            <a href="#">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{t('Join as a Teacher')}</h5>
            </a>
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{t('Share your knowledge and experience by teaching and mentoring students.')}</p>
        ...
        <div className="max-w-sm bg-white border dark:bg-black border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            <a href="#">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{t('Join as a Company')}</h5>
            </a>
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{t('Collaborate with educational institutions and find potential talents.')}</p>
