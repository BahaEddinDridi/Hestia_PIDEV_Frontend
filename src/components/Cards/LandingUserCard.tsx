...
const LandingUserCard: React.FC = () => {
    ...
    <div
      ...
      <div className="flex flex-col ml-6 pb-10">
        <img className="w-24 h-24 my-6 rounded-xl shadow-lg" src={currentUser.image}
             alt="Bonnie image" />
        <h5
          className="mb-3 text-xl font-medium text-gray-900 dark:text-white"> {currentUser && `${currentUser.firstName} ${currentUser.lastName}`}</h5>
        <div className="flex mb-3">
          <svg className="w-4 h-4 text-gray-800 dark:text-white mr-1" aria-hidden="true"
          ...
          <span className="text-sm text-gray-500 dark:text-gray-400">{currentUser && `${currentUser.title} `}</span>
        </div>
        <div className="flex mb-3">
          <svg className="w-4 h-4 text-gray-800 dark:text-white mr-1" aria-hidden="true"
               xmlns="http://www.w3.org/2000/svg"
...
export default LandingUserCard;