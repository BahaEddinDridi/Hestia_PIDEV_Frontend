...
import {selectCurrentUser} from "../../ApiSlices/authSlice";import { useSendLogoutMutation } from '../../ApiSlices/authApiSlice';
...
const [sendLogout, { isLoading }] = useSendLogoutMutation();
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-sidebarcolor duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 rounded-2xl  ${
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      {/* <!-- Dropdown Menu Start --> */}
                      {/* <!-- Dropdown Menu start Users --> */}
                      <div
                        className={`translate transform overflow-hidden ${
                          !open && 'hidden'
                        }`}
                      >
                        <ul className="mt-3 mb-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/Dashboard/tables-Of-Users"
                              className={({ isActive }) =>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/Dashboard/tables-Of-Jobs/Applications"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/Dashboard/tables-Of-Jobs/Opportunities"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              {/* <!-- Menu Item Job Pages --> */}
                      ...
                      {/* <!-- Dropdown Menu end Jobs --> */}
                      {/* ////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
                         {/* <!-- Dropdown Menu start interships --> */}
                         <div
                        className={`translate transform overflow-hidden ${
                          !open && 'hidden'
                        }`}
              ...
              {/* <!-- Menu Item Tables   --> */}
               {/* ///////////////////////////////////////////////////////////////////////////////////////////////////// */}
                ...
                <li>
                <NavLink
                   to={currentUser ? `/Dashboard/calendar` : '#'}
                   className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark hover:text-white dark:hover:bg-meta-4 ${
