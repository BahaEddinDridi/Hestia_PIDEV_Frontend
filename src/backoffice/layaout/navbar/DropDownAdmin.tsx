...
const DropdownUser = () => {
  ...
  const logoutConfirmationRef = useRef<any>(null);
    ...
    <div className="relative">
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          <li>
            <Link
              to={`/Dashboard/ProfileAdmin/${currentUsername}`}
          ...
          <li>
            <Link
              to={currentUsername ? `/Dashboard/ProfileAdmin/${currentUsername}/update` : '#'}
              className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
            >
              <svg
                className="fill-current"
        ...
        {/* <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          <li  className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
            <svg
              className="fill-current"
              width="22"
              height="22"
      ...
      {showLogoutConfirmation && (
        <div
          ...
          className="my-55.5 fixed inset-0 bg-opacity-50 bg-black flex items-center justify-center z-50"
          aria-labelledby="logoutConfirmationTitle"
          aria-describedby="logoutConfirmationDescription"
        >
          <div className="bg-whiten p-10 rounded-md shadow-md flex flex-col items-center">
            <h2 id="logoutConfirmationTitle" className="text-lg font-medium mb-4">
              Are you sure you want to log out?
            </h2>
            <p id="logoutConfirmationDescription" className="text-sm text-gray-600 mb-4">
              You will be logged out of your account.
            </p>
            <div className="flex justify-end">
              <button
                onClick={handleCancelLogout}
                className="px-4 py-2 mr-2 text-sm font-medium text-gray-600 hover:text-gray-800"
              >
                Cancel
              </button>
              <button
                className="px-4 py-2 text-sm font-medium text-red hover:text-red-800"
              >
                Log Out
              </button>
            </div>
