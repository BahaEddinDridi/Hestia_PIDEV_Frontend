        ...
        <div className="relative overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 ml-10 -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3 ">
              ...
              {currentUser.image ? (
                  <img src={currentUser.image} alt="profile" className='w-24 h-24 sm:w-36 sm:h-36 rounded-full overflow-hidden object-cover' />
              ) : selectedImage ? (
                  <img src={selectedImage} alt="profile" className='w-24 h-24 sm:w-36 sm:h-36 rounded-full overflow-hidden object-cover' />
              ) : (
                  <img src={userSix} alt="profile" className='w-24 h-24 sm:w-36 sm:h-36 rounded-full overflow-hidden object-cover'  />
              )
              }
                <label
                  htmlFor="profile"
            ...
            <div className="mt-1 mr-180 ">
              <h3 className="mb-1.5 text-lg sm:text-xl md:text-2xl lg:text-2xl font-semibold text-black dark:text-white">
                {/* Display user's full name */}
                {currentUser && `${currentUser.firstName} ${currentUser.lastName}`}
              </h3>
              <Link to={currentUser ? `/Dashboard/ProfileAdmin/${currentUser.username}/update` : '#'} className="float-right mt-2 text-gray-500 hover:text-gray-700 cursor-pointer">
                <i className="fas fa-pencil-alt mr-1 text-gray-500"></i>
              </Link>


              <p className="font-medium">{currentUser && currentUser.role}</p>
              <div className="flex justify-center mt-4">
                <button

                  className="group ml-10 flex justify-center p-2 rounded-md drop-shadow-xl  from-gray-800  font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                ...
                <button
                  className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800   font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
