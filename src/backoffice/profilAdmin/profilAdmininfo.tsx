...
const profilAdmininfo = ({ index }: { index: number }) => {
...
<div className="grid grid-cols-2  rounded-lg  md:grid-cols-2 gap-8">
  ...
  <div className=" w-full md:w-1/2 p-4">
    ...
    <ul className="grid gap-4">
      {currentUser.education && currentUser.education.length > 0 && educationList.map((edu, index) => (
        ...
        <div className="relative inline-block ">
              ...
              <div id={`dropdownDots-${edu._id}`} className=" absolute right-0 z-1  bg-gray divide-y divide-gray-100 rounded-lg shadow w-50 dark:bg-gray-700 dark:divide-gray-600" aria-labelledby={`dropdownMenuIconButton-${edu._id}`}>
