...
import { fetchApplicationsIntershipAvailable } from "../api";
import IntershipApplicationNotAvailable from "../Tables/IntershipApplicationNotDispo";
...
const currentInterships = filteredInterships
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await fetchApplicationsIntershipAvailable(); 
        setInterships(data);
      } catch (error) {
...
const closeModal = () => {
  ...
  return (
    ...
    <h4 className="mb-6 text-xl font-semibold text-black dark:text-white">
        Table Of Interships Application
    </h4>
     ...
     {showUnavailableOpportunities ? (
      <IntershipApplicationNotAvailable/>
       ) : (
      ...
      placeholder="Search Intership Applications..."
