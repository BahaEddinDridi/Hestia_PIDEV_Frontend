...
const handleDeleteJob = async (id: string, username: string) => {
  ...
  return (
      ...
      className="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-red-800 focus:border-greenadd w-full"
    />
    <button className='px-3 py-2 mx-1 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-red-800 focus:border-greenadd' onClick={startVoiceSearch}>
