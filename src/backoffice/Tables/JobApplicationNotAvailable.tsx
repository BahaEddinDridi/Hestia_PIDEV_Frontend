...
import { fetchApplicationsJobNotAvailable } from "../api";
...
const JobApplicationsNotAvailable = () => {
  //recherche bar
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await fetchApplicationsJobNotAvailable (); 
        setJobs(data);
      } catch (error) {
             ...
             <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5  "style={{ maxHeight: '80vh', overflowY: 'auto' }}>
                    ...
                    <div className="flex ...">
                      ...
                      <a href={application.resume} target="_blank" rel="noopener noreferrer"
                         className="text-red-500 hover:underline">View Resume</a>
                       </div>
                      <div className="flex-1 ... mb-2 font-semibold leading-none text-gray-900 dark:text-black">
                      <div className="flex items-center">
                      Status User
...
export default JobApplicationsNotAvailable;